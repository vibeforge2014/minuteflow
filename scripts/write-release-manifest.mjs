...
const tag = `v${version}`;
const assetUrl = `https://github.com/vibeforge2014/meeting-assistant/releases/download/${tag}/${encodeURIComponent(fileName)}`;
const manifest = {
  schemaVersion: 1,
  version,
  platform: "darwin",
  ...
  notes: `会议助手 ${version} 已发布。包含最新的功能改进、兼容性优化与问题修复。`,
  downloadUrl: "../downloads/macos/latest/",
  releasePageUrl: `https://github.com/vibeforge2014/meeting-assistant/releases/tag/${tag}`,
  assetUrl,
  sha256
};
