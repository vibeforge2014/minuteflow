/**
 * 官网「最新版 Windows 安装包」跳转页脚本（downloads/windows/latest/index.html 内联加载）：
 * 拉取同站 releases/latest-windows.json 更新清单，校验 assetUrl 只能是
...
fetch("../../../releases/latest-windows.json", { headers: { Accept: "application/json" } })
  .then((response) => {
